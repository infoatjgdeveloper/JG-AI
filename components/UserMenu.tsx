                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-sm leading-relaxed mb-6 max-w-sm text-slate-400">
                            Engineering the intelligence of tomorrow for enterprises across 37+ countries. Headquartered in India, operating globally through <strong className="text-white">BRJU Infosec Inc.</strong> (North America) and <strong className="text-white">IA7 Global Tech</strong> (Europe).
                        </p>
