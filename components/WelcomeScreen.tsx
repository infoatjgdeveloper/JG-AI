            ...
            <section aria-labelledby="awards-heading" className="max-w-[90rem] mx-auto px-4 md:px-8 lg:px-16 mb-32">
                ...
                <div className="bg-slate-900 dark:bg-slate-800 rounded-3xl grid grid-cols-2 md:grid-cols-5 gap-px overflow-hidden border border-slate-800">
                    {[
                        ...
                        { icon: '🛡️', t: 'GDPR Compliant', s: 'EU Data Protection Standard' },
                        { icon: '⚡', t: 'Best AI Startup', s: 'South Asia Tech Awards 2024' },
                        { icon: '☁️', t: 'Microsoft Gold Partner', s: 'Cloud Solutions Program' },
                    ].map((a, i) => (
                    ...
                    <div>
                        ...
                        <ul className="space-y-3" role="list">
                            {[
                                ...
                                { t: 'Security-by-Design', d: 'ISO 27001, GDPR, SOC2 compliance baked into every layer, not bolted on' },
                    ...
                    <div className="bg-slate-50 dark:bg-slate-800 rounded-3xl p-8 border border-slate-100 dark:border-slate-700">
                        ...
                        <ol className="space-y-6" role="list">
                            {[
                                ...
                                { y: '2023', t: 'IA7 Global Tech — Europe', d: 'EU-based entity launched; GDPR-compliant AI stack deployed for European enterprise market' },
                                { y: '2024', t: '37+ Countries · Top AI Company Award', d: '500+ projects delivered; ISO 27001 certified; named Top AI Company by Global Tech Review' },
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        ...
                        },
                        {
                            ...
                            desc: 'JGAI’s dedicated North American LLC, purpose-built for enterprise cybersecurity and InfoSec. BRJU Infosec delivers penetration testing, 24/7 SOC monitoring, zero trust architecture, and AI-powered threat intelligence — with ISO 27001, SOC2, and GDPR.',
                        ...
                        },
                        {
                            ...
                            desc: 'JGAI’s EU-registered entity built for the European enterprise market. IA7 Global Tech delivers elite AI systems, GDPR-native data platforms, and full-stack digital transformation across the UK, Germany, France, Netherlands, and the wider EU.',
                            tags: ['Elite IT Systems', 'GDPR-Native AI', 'EU Compliance', 'UK & Europe'],
                        ...
                        {[
                            ...
                            },
                            {
                                ...
                                features: [
                                    ...
                                    'ISO 27001, GDPR, SOC2 & HIPAA Compliance',
            ...
            <section id="testimonials" aria-labelledby="testimonials-heading" className="max-w-[90rem] mx-auto px-4 md:px-8 lg:px-16 mb-32">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        ...
                        {
                            quote: 'IA7 Global Tech built our GDPR-compliant AI data platform entirely from scratch — on time, on budget, and without a single compliance incident. The platform now processes 2 million client records daily.',
                            name: 'Marcus L.',
